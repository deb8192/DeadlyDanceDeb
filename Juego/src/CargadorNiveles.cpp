    ...
    int ancho, int largo, int alto, Sala* sala)
{
    ...
    _motor->CargarEnemigos(x,y,z,_enemigos.back()->GetModelo(),_enemigos.back()->GetTextura(), false,_enemigos.back()->GetAnimacion(),_enemigos.back()->GetFps(),0.0f,_enemigos.back()->GetEscalado());//creamos la figura
