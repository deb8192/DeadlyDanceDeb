    ...
    class MotorGrafico
    {
        public: //clases accesibles desde fuera
            ...
            */
            ...
            void CargarArma(unsigned int id,const char * modelo,unsigned int fps, const char * anima, float escalado,const char * textura);//crea un arma en el id(0 a maximo de armas) que le pases 
            void MoverArma(unsigned id, float x, float y, float z);
            void RotarArma(unsigned id, float x, float y , float z);
        ...
        private: //clases solo accesibles por MotorGrafico
            ...
            void propiedadesDevice();
                ...
                vector<unsigned short> _imagenesF;
                ...
                Animaciones * armasAni[14];//contiene la logica de animacion de cada arma
