...
int main()
{
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT); //clear del buffer de profundidad
        ...
        view = glm::translate(view, glm::vec3(0.0f, 0.0f, -3.0f));   //mover el eje z de la escena de la vista en -3.0
        //Aplicar proyeccion en la escena
        glm::mat4 projection = glm::mat4(1.0f);
        projection = glm::perspective(glm::radians(45.0f), (float)SCR_WIDTH/(float)SCR_HEIGHT, 0.1f, 100.0f);
        //Enviar todo a los uniform del shader
